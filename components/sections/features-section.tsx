    ...
    >
      <div className="relative z-10 space-y-32 md:space-y-40">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-[0.88fr_1.12fr] gap-12 lg:gap-20 items-center">
          {/* Left Text */}
          <AnimatedContainer variant="slideLeft" className="space-y-6 order-2 lg:order-1">
            <Badge variant="default">New Generation</Badge>

            <h2 className="text-3xl md:text-4xl lg:text-[2.75rem] font-medium tracking-tight leading-tight text-text-primary">
            ...
            <StaggerContainer className="space-y-4 pt-2" staggerDelay={0.12} delayStart={0.3}>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 lg:gap-44 items-center">
          {/* Left Image */}
          ...
          {/* Right Text */}
          <AnimatedContainer variant="slideRight" className="relative order-2 lg:justify-self-end lg:-translate-x-6">
